...
- (void)application:(UIApplication * _Nonnull)application handleWatchKitExtensionRequest:(NSDictionary * _Nullable)userInfo reply:(void (^ _Nonnull)(NSDictionary * _Nullable))reply;
...
@property (nonatomic, strong) PhoneToWatchService * _Null_unspecified watchService;
- (void)viewDidLoad;
...
- (void)sendRecipesToWatchWithRecipes:(NSArray<Recipe *> * _Nonnull)recipes;
...
+ (void)fetchAllFrom:(NSPersistentContainer * _Nonnull)container completion:(void (^ _Nonnull)(NSArray<Recipe *> * _Nonnull))completion;
@end
